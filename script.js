...
// Load Announcements
Papa.parse(announcementsCSV, { download:true, header:true, complete:function(results){
...
// Load Games
Papa.parse(gamesCSV, { download:true, header:true, complete:function(results){
...
// Popup close
document.getElementById('closePopup').addEventListener('click',()=>document.getElementById('gamePopup').style.display='none');
window.addEventListener('click',(e)=>{ if(e.target===document.getElementById('gamePopup')) document.getElementById('gamePopup').style.display='none'; });
